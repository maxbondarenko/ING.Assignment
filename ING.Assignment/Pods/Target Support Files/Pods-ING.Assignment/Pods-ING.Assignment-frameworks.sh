...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/RxAlamofire-iOS9.0/RxAlamofire.framework"
  install_framework "$BUILT_PRODUCTS_DIR/RxCocoa-iOS9.0/RxCocoa.framework"
  install_framework "$BUILT_PRODUCTS_DIR/RxDataSources-iOS9.0/RxDataSources.framework"
